       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="#" class="btn btn-success btn-sm">
                   ...
                   if(!isset($_SESSION['customer_email'])){
                       ...
                       echo "Vitajte a neváhajte sa zaregistrovať";
               ...
               <a href="checkout.php"><?php items(); ?> položiek v košíku | Suma celkom: <?php total_price(); ?> </a>
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                   ...
                   <li>
                       <a href="customer_register.php">Registtrovať sa</a>
                   </li>
                   <li>
                   ...
                   <li>
                       <a href="checkout.php">
                           ...
                           if(!isset($_SESSION['customer_email'])){
                                ...
                                echo "<a href='checkout.php'> Prihlásiť sa </a>";
                       ...
                       <div class="box-footer"><!-- box-footer Begin -->
                           ...
                           <div class="pull-left"><!-- pull-left Begin -->
                               ...
                               <a href="index.php" class="btn btn-default"><!-- btn btn-default Begin -->
                                   ...
                                   <i class="fa fa-chevron-left"></i> Pokračovať k objednávke
