       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="#" class="btn btn-success btn-sm">
                   ...
                   if(!isset($_SESSION['customer_email'])){
                       ...
                       echo "Vitajte a neváhajte sa prihlásiť";
                       
                   }else{
                       
                       echo "Vitajte: " . $_SESSION['customer_email'] . "";
               ...
               <a href="checkout.php"><?php items(); ?> položiek v košíku | Celková cena: <?php total_price(); ?> </a>
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                   ...
                   <li>
                       <a href="customer_register.php">Registrujte sa</a>
                   </li>
                   <li>
                       <a href="checkout.php">Môj účet</a>
                   </li>
                   <li>
                       <a href="cart.php">Do košíka</a>
                   </li>
                   <li>
                       <a href="checkout.php">
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/papoochalogomobile.png" alt="Papoocha Logo Mobile" class="visible-xs">
           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <a href="cart.php" class="btn navbar-btn btn-primary right"><!-- btn navbar-btn btn-primary Begin -->
                   ...
                   <span><?php items(); ?> položiek v košíku</span>
                       ...
                       <div id="mainImage"><!-- #mainImage Begin -->
                           <div id="myCarousel" class="carousel slide" data-ride="carousel"><!-- carousel slide Begin -->
                               ...
                               <div class="carousel-inner">
                                   ...
                                   <div class="item">
                                       <center><img class="img-responsive" src="admin_area/p
roduct_images/<?php echo $pro_img2; ?>" alt="Product 3-b"></center>
                                   </div>
                                   <div class="item">
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           ...
                           <form class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">Veľkosť</label>
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 size for the product')"><!-- form-control Begin -->
                                           ...
                                           <option value="" disabled selected>Vyberte si veľkosť</option>
                                           <option>28</option>
                                           <option>29</option>
                                           <option>30</option>
                                           <option>31</option>
                               ...
                               <?php 
                                    ...
                                    if($pro_label == "sale"){
                                        ...
                                        echo "
                                            ...
                                            Cena: <del> $pro_price €</del><br/>

                                            Akcia:     $pro_sale_price € 
                               ...
                               <p class="text-center buttons"><button type="submit" name="add_cart" class="btn btn-primary i fa fa-shopping-cart"> Vložiť do košíka</button></p>
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Begin -->
                       <div class="box same-height headline"><!-- box same-height headline Begin -->
                           <h3 class="text-center">Papuče, ktoré by sa vám mohli páčiť</h3>
