           ...
           <div id="cart" class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="cart.php" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <p class="text-muted"> Počet párov papúč vo vašom košíku <?php echo $count; ?></p>
                       ...
                       <div class="box-footer"><!-- box-footer Begin -->
                           ...
                           <div class="pull-right"><!-- pull-right Begin -->
                               ...
                               <button type="submit" name="update" value="Refreshnúť košík" class="btn btn-default"><!-- btn btn-default Begin -->
                                   
                                   <i class="fa fa-refresh"></i> Refreshnúť košík
                                   
                               </button><!-- btn btn-default Finish -->
                               
                               <a href="checkout.php" class="btn btn-primary">
                                   
                                   Pokračovať k objednávke <i class="fa fa-chevron-right"></i>
                        ...
                        if($code == ""){
                            ...
                            if($check_coupons == "1"){
                                ...
                                if($coupon_limit == $coupon_used){
                                    ...
                                    echo "<script>alert('Planosť kupónu vypršala')</script>";
                                    ...
                                    if($check_cart == "1"){
                                        ...
                                        echo "<script>alert('Váš kupon bol použitý')</script>";
                                        echo "<script>window.open('cart.php','_self')</script>";

                                    }else{

                                        echo "<script>alert('Číslo kupónu nesedí s použitým kupónom v košíku')</script>";
                                ...
                                echo "<script>alert('Nesprávny kupón')</script>";
