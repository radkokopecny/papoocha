...
<h1 align="center"> Upraviť účet </h1>
...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="form-group"><!-- form-group Begin -->
        ...
        <img class="img-responsive" src="customer_images/<?php echo $customer_image; ?>">
    ...
    <div class="text-center"><!-- text-center Begin -->
        ...
        <button name="update" class="btn btn-primary"><!-- btn btn-primary Begin -->
            ...
            <i class="fa fa-user-md"></i> Updatnúť
...
if(isset($_POST['update'])){
    ...
    if($run_customer){
        ...
        echo "<script>alert('Váš účet bol upravený. Začnite opätovným prihlásením')</script>";
